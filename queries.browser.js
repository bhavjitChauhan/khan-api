...
`,
  allFlaggedGuideThreads: `query allFlaggedGuideThreads($cursor: String) {
  allFlaggedGuideThreads: allAiGuideThreads(moderationStatus: FLAGGED, cursor: $cursor) {
    threads {
      id
      user {
        id
...
`,
  getOffensiveTerms: `query getOffensiveTerms {
  offensiveTerms {
    id
    term
    __typename
...
`,
  GetTopicQuestionsQuery: `query GetTopicQuestionsQuery($topicSlug: String!, $cursor: String, $limit: Int, $feedbackType: FeedbackType, $forceInTutorial: Boolean, $minAnswers: Int, $maxAnswers: Int) {
