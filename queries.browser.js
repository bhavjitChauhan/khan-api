...
fragment gtp_essayScoresFragment on EssayScores {
  ...
  guideTranscripts: `query guideTranscripts($kaid: String!, $cursor: String, $startDate: DateTime, $endDate: DateTime, $moderationStatus: ModerationStatus, $limit: Int, $configName: String) {
  aiGuideThreads(
    kaid: $kaid
    cursor: $cursor
    startDate: $startDate
...
fragment skillLevelChangeFields on SkillLevelChange {
  ...
  KAClassroom_GetAssignmentProgressByStudent: `query KAClassroom_GetAssignmentProgressByStudent($assignmentFilters: CoachAssignmentFilters, $classDescriptor: String!, $pageSize: Int, $after: ID) {
  classroom: classroomByDescriptor(descriptor: $classDescriptor) {
    id
    cacheId
    descriptor
  ...
  useBypassRolePickerCurrentUserKAID: `query useBypassRolePickerCurrentUserKAID {
  user {
    id
    kaid
    __typename
