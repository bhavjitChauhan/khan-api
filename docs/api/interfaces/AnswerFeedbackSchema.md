# Interface: AnswerFeedbackSchema
...
• **\_\_typename**: [`AnswerFeedback`](api/enums/FeedbackTypename.md#answerfeedback)
...
[src/types/schema.ts:395](https://github.com/bhavjitChauhan/khan-api/blob/9bcea3fc/src/types/schema.ts#L395)
...
• **feedbackType**: [`ANSWER`](api/enums/FeedbackType.md#answer)
...
[src/types/schema.ts:396](https://github.com/bhavjitChauhan/khan-api/blob/9bcea3fc/src/types/schema.ts#L396)
...
• **question**: `Pick`\<[`QuestionFeedbackSchema`](api/interfaces/QuestionFeedbackSchema.md), ``"__typename"`` \| ``"deleted"`` \| ``"key"`` \| ``"sumVotesIncremented"`` \| ``"flaggedBy"`` \| ``"flags"`` \| ``"upVoted"`` \| ``"appearsAsDeleted"`` \| ``"author"`` \| ``"content"`` \| ``"date"`` \| ``"definitelyNotSpam"`` \| ``"downVoted"`` \| ``"expandKey"`` \| ``"feedbackType"`` \| ``"focusUrl"`` \| ``"fromVideoAuthor"`` \| ``"isLocked"`` \| ``"isPinned"`` \| ``"lowQualityScore"`` \| ``"notifyOnAnswer"`` \| ``"permalink"`` \| ``"qualityKind"`` \| ``"replyCount"`` \| ``"replyExpandKeys"`` \| ``"showLowQualityNotice"``\>

#### Defined in

[src/types/schema.ts:397](https://github.com/bhavjitChauhan/khan-api/blob/9bcea3fc/src/types/schema.ts#L397)
