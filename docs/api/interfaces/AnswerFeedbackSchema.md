Defined in: [src/types/schema.ts:400](https://github.com/bhavjitChauhan/khan-api/blob/67d30ab4498111952301bcaddbef9a132bf75105/src/types/schema.ts#L400)
...
> **\_\_typename**: [`AnswerFeedback`](api/enumerations%5CFeedbackTypename.md#answerfeedback)

Defined in: [src/types/schema.ts:401](https://github.com/bhavjitChauhan/khan-api/blob/67d30ab4498111952301bcaddbef9a132bf75105/src/types/schema.ts#L401)
...
> **feedbackType**: [`ANSWER`](api/enumerations%5CFeedbackType.md#answer)

Defined in: [src/types/schema.ts:402](https://github.com/bhavjitChauhan/khan-api/blob/67d30ab4498111952301bcaddbef9a132bf75105/src/types/schema.ts#L402)
...
> **question**: `Pick`\<[`QuestionFeedbackSchema`](api/interfaces%5CQuestionFeedbackSchema.md), `"__typename"` \| `"deleted"` \| `"key"` \| `"sumVotesIncremented"` \| `"flaggedBy"` \| `"flags"` \| `"upVoted"` \| `"appearsAsDeleted"` \| `"author"` \| `"content"` \| `"date"` \| `"definitelyNotSpam"` \| `"downVoted"` \| `"expandKey"` \| `"feedbackType"` \| `"focusUrl"` \| `"fromVideoAuthor"` \| `"isLocked"` \| `"isPinned"` \| `"lowQualityScore"` \| `"notifyOnAnswer"` \| `"permalink"` \| `"qualityKind"` \| `"replyCount"` \| `"replyExpandKeys"` \| `"showLowQualityNotice"`\>

Defined in: [src/types/schema.ts:403](https://github.com/bhavjitChauhan/khan-api/blob/67d30ab4498111952301bcaddbef9a132bf75105/src/types/schema.ts#L403)
