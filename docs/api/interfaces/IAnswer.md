...
• `Optional` **question**: [`Question`](api/classes/Question.md)

#### Defined in

[src/lib/messages/Answer.ts:13](https://github.com/bhavjitChauhan/khan-api/blob/9bcea3fc/src/lib/messages/Answer.ts#L13)
