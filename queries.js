...
`,
  ...
  stringTranslation(
    ...
    kaLocale: $kaLocale
    messageLocation: "devadmin-automatic-translation-test"
  ) {
    found
    isAITranslated
    isNewTranslation
...
fragment ActivitySessionSkillLevels on SkillLevelChange {
  ...
  getAdminsForInProductAdminRostering: `query getAdminsForInProductAdminRostering($partnershipID: ID!) {
  getVisibleAdminUDIs(partnershipID: $partnershipID, allowPartial: true) {
    id
    displayNameForTeacher
    districtProvidedEmail
    districtProvidedFirstName
