...
`,
  createDistrict: `mutation createDistrict($name: String!, $offerings: [Offering!]!, $rosterSource: RosterSource!, $isTest: Boolean!, $rosterID: String!, $nweaID: String!, $ncesID: String, $sendEmails: Boolean!, $goLiveDate: Date!, $schoolYearDates: DistrictSchoolYearInput!) {
  createDistrict(name: $name, offerings: $offerings, isTest: $isTest, rosterID: $rosterID, rosterSource: $rosterSource, nweaID: $nweaID, ncesID: $ncesID, sendTeacherActivationEmails: $sendEmails, goLiveDate: $goLiveDate, schoolYearDates: $schoolYearDates) {
    error {
      code
      __typename
    }
...
`,
  createOffensiveTerm: `mutation createOffensiveTerm($term: String!, $kaLocale: String) {
  createNewOffensiveTerm(term: $term, kaLocale: $kaLocale) {
    offensiveTerm {
      id
      term
      __typename
...
`,
  ...
  devadminTriggerAlarm(level: $level, subject: $subject, contents: $contents) {
    error {
      code
      __typename
    }
...
`,
  modifyDistrict: `mutation modifyDistrict($existingDistrictID: ID!, $newName: String, $offerings: [Offering!], $rosterSyncingEnabled: Boolean, $rosterID: String, $rosterSource: RosterSource, $nweaID: String, $ncesID: String, $isTest: Boolean, $sendTeacherActivationEmails: Boolean, $goLiveDate: Date, $kaLocale: String, $schoolYearDates: DistrictSchoolYearInput) {
  modifyDistrict(existingDistrictID: $existingDistrictID, newName: $newName, offerings: $offerings, rosterSyncingEnabled: $rosterSyncingEnabled, rosterID: $rosterID, rosterSource: $rosterSource, nweaID: $nweaID, ncesID: $ncesID, isTest: $isTest, sendTeacherActivationEmails: $sendTeacherActivationEmails, goLiveDate: $goLiveDate, kaLocale: $kaLocale, schoolYearDates: $schoolYearDates) {
    district {
      id
      rosterID
      name
...
`,
  SetBasicSettings: `mutation SetBasicSettings($kaid: String!, $nickname: String, $username: String, $soundOn: Boolean, $userLanguage: String, $birthdate: String) {
  setSettings(kaid: $kaid, nickname: $nickname, username: $username, soundOn: $soundOn, userLanguage: $userLanguage, birthdate: $birthdate) {
    user {
      id
      nickname
      username
...
`,
  setSettingsMutationWithErrors: `mutation setSettingsMutationWithErrors($kaid: String!, $nickname: String, $username: String, $soundOn: Boolean, $muteVideos: Boolean, $showCaptions: Boolean, $playbackRate: PlaybackRate, $userLanguage: String, $birthdate: String, $hideVisual: Boolean, $prefersReducedMotion: Boolean, $noColorInVideos: Boolean) {
  setSettings(kaid: $kaid, nickname: $nickname, username: $username, soundOn: $soundOn, muteVideos: $muteVideos, showCaptions: $showCaptions, playbackRate: $playbackRate, userLanguage: $userLanguage, birthdate: $birthdate, hideVisual: $hideVisual, prefersReducedMotion: $prefersReducedMotion, noColorInVideos: $noColorInVideos) {
    user {
      id
      nickname
      username
